...
public class MilliTimer {
    ...
    public String getString(String prefix, String suffix) {
        ...
        try {
            ...
            return prefix + String.format("%.2f", val) + suffix;
        } finally {
            ct0 = ct1;
        }
    }
    ...
    public boolean isExpired(long expireValue, String[] status) {
        long ct1 = System.nanoTime();
        double val = 0.000001 * (ct1-ct0);
        String f = SundryUtil.formatMilliTime((ct1-ct0)/1000000, 0, true, false);
        String e = SundryUtil.formatMilliTime(expireValue, 0, true, false);
